...
def put_request_returns_response(return_PutData_obj):            
    response = requests.put("https://gorest.co.in/public-api/users/" + str(return_PutData_obj.ID),
        headers={'Authorization': 'Bearer VqRUbB84gJ6bMP97UeRK3MYpC608ZRcsVVYd'}, data = return_PutData_obj.payload)        
    return response
...
def delete_request_returns_response(return_DELETEData_obj):    
    response = requests.delete("https://gorest.co.in/public-api/users/" + return_DELETEData_obj.ID, headers={'Authorization': 'Bearer VqRUbB84gJ6bMP97UeRK3MYpC608ZRcsVVYd'})        
    return response
